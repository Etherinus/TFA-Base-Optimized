...
local function gen(input)
    return "STATUS_" .. string.upper(input)
end
...
local statusList = {
    "idle", "draw", "holster", "holster_final", "holster_ready",
    "reloading", "reloading_wait", "reloading_shotgun_start",
    "reloading_shotgun_start_shell", "reloading_shotgun_loop",
    "reloading_shotgun_end", "shooting", "silencer_toggle",
    "bashing", "inspecting", "fidget", "pump", "grenade_pull",
    "grenade_ready", "grenade_throw"
}

for _, st in ipairs(statusList) do
    TFA.AddStatus(st)
end
